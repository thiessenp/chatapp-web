...
-- message from username3 to no user (general message)
INSERT INTO chat_message (chat_id, from_chat_user_id, content) VALUES('f729dd6c-a130-4725-9d98-10137727a821', '791be344-1acb-4d15-9284-fe325edfb481', 'content - message from username3 to the chat (no specific user) (chat1)');
...
-- message from username3 to no user (general message)
INSERT INTO chat_message (chat_id, from_chat_user_id, content) VALUES('b863b0ba-44ff-49d4-a3a8-d62b59cb90fd', 'eac92561-0666-47dc-9cac-f7268edf088c', 'content - message from username3 to the chat (no specific user) (chat2)');

-- Get messages from Chat1
SELECT * FROM chat_message WHERE chat_id = 'f729dd6c-a130-4725-9d98-10137727a821';
-- Get users from Chat1
SELECT * FROM chat_user WHERE chat_id = 'f729dd6c-a130-4725-9d98-10137727a821';
-- Get messages from Chat2
SELECT * FROM chat_message WHERE chat_id = 'b863b0ba-44ff-49d4-a3a8-d62b59cb90fd';
-- Get users from Chat1
SELECT * FROM chat_user WHERE chat_id = 'b863b0ba-44ff-49d4-a3a8-d62b59cb90fd';

-- >>>>>>>>>>>>>>>>>>>>>>
-- TODO
--
-- Unions or someting? Example getting users authenticated (online)
-- Example union getting Chat messages with all "branching" data
-- >>>>>>>>>>>>>>>>>>>>>>